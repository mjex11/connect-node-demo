...
function validateUniversalHandlerOptions(opt) {
    ...
    const shutdownSignal = (_b = opt.shutdownSignal) !== null && _b !== void 0 ? _b : neverSignal;
    const maxDeadlineDurationMs = (_c = opt.maxDeadlineDurationMs) !== null && _c !== void 0 ? _c : Number.MAX_SAFE_INTEGER;
    return Object.assign(Object.assign({ acceptCompression }, (0, limit_io_js_1.validateReadWriteMaxBytes)(opt.readMaxBytes, opt.writeMaxBytes, opt.compressMinBytes)), { jsonOptions: opt.jsonOptions, binaryOptions: opt.binaryOptions, maxDeadlineDurationMs,
        shutdownSignal,
